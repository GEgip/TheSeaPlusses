...
{
	(*this) = s; //equivalent (*this).operator=(s);
}

MyString::MyString(char ch)
{
	(*this) = ch; //invoca MyString & MyString::operator=(char ch)
}

MyString::MyString(const MyString& aMyString)
{
	(*this) = aMyString; // invoca: MyString & MyString::operator=(const MyString & aMyString)
}
...
{
	(*this) = ""; //(*this).operator=(""); --> MyString & MyString::operator=(const char * s)
	(*this) = (*this) + ch; 
	return(*this);
}
...
{
	return ((*this) + aMyString.s); //(*this).operator+(aMyString.s)
}
...
ostream& operator<<(std::ostream& out, const MyString& aMyString)
{
	out << aMyString.s;
	return(out);
}
